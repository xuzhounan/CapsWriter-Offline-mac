...
| 阶段 | 时间 | 主要交付物 | 验收标准 |
|------|------|------------|----------|
| 第一阶段 | Week 1-2 | 核心架构重构 | 配置系统可用，状态管理清晰 |
| 第二阶段 | Week 3-4 | 服务层重构 | 热词功能恢复，业务逻辑分离 |
| 第三阶段 | Week 5-6 | 功能补齐 | 标点处理，文件转录可用 |
| 第四阶段 | Week 7-8 | UI 体验优化 | 用户界面完善，配置便捷 |
| 第五阶段 | Week 9-10 | 测试和优化 | 性能稳定，测试覆盖率 >80% |
